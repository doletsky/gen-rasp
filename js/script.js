            ...
            if(addPrist.length){
                ...
                $(".input_prist_s")
                    .append('<input class="person" type="text" value="'+addPrist+'" name="ips'+cnt+'"><span name="ips'+cnt+'" class="del">x</span>' +
                        ' <span name="ips'+cnt+'" class="dweek" value="1">Пн</span>'+
                        ' <span name="ips'+cnt+'" class="dweek" value="2">Вт</span>'+
                        ' <span name="ips'+cnt+'" class="dweek" value="3">Ср</span>'+
                        ' <span name="ips'+cnt+'" class="dweek" value="4">Чт</span>'+
                        ' <span name="ips'+cnt+'" class="dweek" value="5">Пт</span>'+
                        ' <span name="ips'+cnt+'" class="dweek" value="6">Сб</span>'+
                        ' <span name="ips'+cnt+'" class="dweek act" value="7">Вс</span>'+
